...
<td>Preamble; i is DVI version number which is 2. l is considered a magnification; 1 unit is set to <img alt="{j \over k} 10^{-7} \mbox{m}" class="latex" src="http://s0.wp.com/latex.php?latex=%7Bj+%5Cover+k%7D+10%5E%7B-7%7D+%5Cmbox%7Bm%7D&amp;bg=ffffff&amp;fg=333333&amp;s=0" title="{j \over k} 10^{-7} \mbox{m}"/> and the entire document is scaled by a factor of <img alt="{l \over 1000}" class="latex" src="http://s0.wp.com/latex.php?latex=%7Bl+%5Cover+1000%7D&amp;bg=ffffff&amp;fg=333333&amp;s=0" title="{l \over 1000}"/>. A is an information header</td>
</tr>
<tr>
<td>F8</td>
<td>post</td>
